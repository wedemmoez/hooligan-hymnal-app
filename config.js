...
export const Urls = {
 ...
 HooliganHymnalServer: "https://dbg-hymnal-prod.herokuapp.com",
  ...
  Facebook: "https://facebook.com/DallasBeerGrdns",
  Instagram: "https://instagram.com/dallasguardians",
  Website: "http://dallasbeerguardians.com",
  YouTube: "https://www.youtube.com/channel/UCw8qWax-THD2Emq3CaAXo_w",
...
export const Images = {
  ...
  Home_HeroVideo: require("./assets/home-hero-video.mov"),
...
export const Palette = {
  Navy: '#002457', //actually DarkBlue (splash color)
  Red: '#E10600',
  Blue: '#003087',
  White: '#FFFFFF',
  Black: '#000000',
...
export const Skin = {
  ...
  SongbookCover_ActivityIndicatorColor: Palette.White,
  SongbookCover_Background: DefaultColors.Primary,
...
export const NavigationDrawerItems = [
  ...
  {
    drawerLabel: i18n.t("navigation.links.joinUs"),
    drawerIcon: "account-plus",
    url: Urls.joinUS,
  },
  {
...
export const Settings = {
  ...
  RosterFoes_DefaultCompetition: "MLS",
